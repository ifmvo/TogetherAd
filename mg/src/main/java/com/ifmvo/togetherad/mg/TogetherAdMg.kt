...
object TogetherAdMg {
    ...
    fun init(context: Context, adProviderType: String, mgAdAppId: String, mgAdAppKey: String) {
        return init(context, adProviderType, mgAdAppId, mgAdAppKey, null, null)
    }

    fun init(context: Context, adProviderType: String, mgAdAppId: String, mgAdAppKey: String, providerClassPath: String? = null) {
        return init(context, adProviderType, mgAdAppId, mgAdAppKey, null, providerClassPath)
    }

    fun init(context: Context, adProviderType: String, mgAdAppId: String, mgAdAppKey: String, mgIdMap: Map<String, String>? = null) {
        return init(context, adProviderType, mgAdAppId, mgAdAppKey, mgIdMap, null)
    }

    fun init(context: Context, adProviderType: String, mgAdAppId: String, mgAdAppKey: String, mgIdMap: Map<String, String>? = null, providerClassPath: String? = null) {
