...
dependencies {
    ...
    //核心库（ 必要 ）
    implementation 'com.github.ifmvo.TogetherAd:core:5.2.3'

    //腾讯优量汇 （ 可选 ）
    implementation 'com.github.ifmvo.TogetherAd:gdt:5.2.3'

    //穿山甲 （ 可选 ）
    implementation 'com.github.ifmvo.TogetherAd:csj:5.2.3'

    //快手联盟 （ 可选 ）
    implementation 'com.github.ifmvo.TogetherAd:ks:5.2.3'

    //百度百青藤 （ 可选 ）
    implementation 'com.github.ifmvo.TogetherAd:baidu:5.2.3'

}
```

> 对应版本：穿山甲4.5.1.1；优量汇4.470.1340；快手3.3.25；百度5.91
