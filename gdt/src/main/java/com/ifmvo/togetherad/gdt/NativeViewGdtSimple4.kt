 ...
 */
class NativeViewGdtSimple4(onDismiss: (providerType: String) -> Unit) : BaseNativeView() {
    ...
    override fun showNative(adProviderType: String, adObject: Any, container: ViewGroup, listener: NativeViewListener?) {
        ...
        val rootView = View.inflate(container.context, R.layout.layout_native_view_gdt_simple_4, container)
