...
dependencies {
    ...
    //穿山甲（ 头条 ）
    implementation 'com.matthewchen.togetherad:csj:3.0.6-3.0.0.4'
    
    //优量汇（ 腾讯广点通 ）
    implementation 'com.matthewchen.togetherad:gdt:3.0.6-4.211.1081'
    
    //百青藤 ( 百度 Mob )
    implementation 'com.matthewchen.togetherad:baidu:3.0.6-5.85'
