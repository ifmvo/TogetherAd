...
dependencies {
    ...
    //穿山甲（ 头条 ）
    implementation 'com.matthewchen.togetherad:csj:3.0.2-2.9.5.6'
    
    //优量汇（ 腾讯广点通 ）
    implementation 'com.matthewchen.togetherad:gdt:3.0.2-4.211.1081'
    
    //百青藤 ( 百度 Mob )
    implementation 'com.matthewchen.togetherad:baidu:3.0.2-5.83'
